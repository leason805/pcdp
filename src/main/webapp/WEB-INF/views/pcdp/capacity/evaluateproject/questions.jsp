	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="${ctx}/system/capacity/evaluateproject/questionupdate/${model.id}.htm">
					<input type="hidden" name="questid" id="questid" value=""/>
					<div class="form-group">
						<label class="col-sm-2 control-label">标题</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="标题" data-toggle="tooltip" data-placement="bottom" title="标题" name="title">
						</div>
					</div>
					<div class="form-group">
								...
								<div class="card" style="">
									<h4 class="page-header">&nbsp;
										<span style="float:right; font-size: 16px;">
											<a href="${ctx}/system/capacity/evaluateproject/editquestion/${question.id}.htm"><i class="fa fa-edit"></i>编&nbsp;辑</a>&nbsp;&nbsp;
											<a href="javascript:del(${question.id});"><i class="fa fa-edit"></i>删&nbsp;除</a>
										</span>
									</h4>
								</div>
...
function del(id){
	$.messager.confirm('确认信息', '确认删除？', function(r){
		if (r){
			document.location.href = "${ctx}/system/capacity/evaluateproject/delquestion/" + id + ".htm";
		}
	});
}
</script>
