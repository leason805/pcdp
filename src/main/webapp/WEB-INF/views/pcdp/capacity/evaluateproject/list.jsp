			...
			<div class="box-content no-padding table-responsive">
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-m">
					<thead>
						...
						<tr>
							<th colspan="3">
								<a class='iframe btn btn-primary btn-label-left' href="${ctx}/system/capacity/evaluateproject/show/.htm">
...
function UserTable(){
	...
	oTable = $('#datatable-m').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/capacity/evaluateproject/listdata.htm",
		"aoColumns": [
		              { "mData": "name" },
		              { "mData": "description" },
		              { "mData": "id" }
		 ...
		 },
		 {
		        "mRender": function(data, type, row) {
		          ...
		          return '<a href="#" onclick="edit(1,' + data + ');">编辑</a>&nbsp;&nbsp;' + '<a href="#" onclick="edit(2,' + data + ');">考核试题</a>&nbsp;&nbsp;';
		        },
		        "aTargets": [2]
		 }
		 ],
...
function edit(type, id){
	var url = "";
	if(type == 1){
		url = "${ctx}/system/capacity/evaluateproject/show/" + id + ".htm";
		$.colorbox({href:url, iframe:true, width:"65%", height:"100%"});
	}
	if(type == 2){
		url = "${ctx}/system/capacity/evaluateproject/questions/" + id + ".htm";
