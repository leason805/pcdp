						...
						<thead>
							<tr role="row">
								<th rowspan="1" colspan="3">
									<a class="iframe btn btn-primary btn-label-left cboxElement" href="${ctx}/system/capacity/item/add/${id}.htm">
						...
						<tbody aria-relevant="all" aria-live="polite" role="alert">
							<c:forEach items="${list}" var="cur"> 
								<tr class="odd">
									...
									<td class=""><a href="${ctx}/system/capacity/item/edit/${cur.id}.htm">编辑</a>&nbsp;&nbsp;
...
function del(id){
	$.messager.confirm('确认信息', '确认删除？', function(r){
		if (r){
			document.location.href = "${ctx}/system/capacity/item/delitem/" + id + ".htm";
		}
	});
}
