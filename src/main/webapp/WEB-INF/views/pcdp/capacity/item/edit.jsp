	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="${ctx}/system/capacity/item/updateitem/${model.id }.htm">

					<div class="form-group ">
						<label class="col-sm-2 control-label">序号</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="序号" data-toggle="tooltip" data-placement="bottom" title="序号" name="sequence" value="${model.sequence}">
						</div>
