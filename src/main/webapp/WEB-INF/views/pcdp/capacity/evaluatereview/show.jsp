...
$(document).ready(function() {
	...
	<frameset rows="5,1*" frameborder="no" framespacing="0">
		...
		<frameset cols="40%,*" >
			<frame src="${ctx}/system/capacity/evaluatereview/detail/${id}.htm" name="nav" scrolling="YES" marginwidth="0" marginheight="0">
			<frame src="${ctx}/system/capacity/evaluatereview/content/${id}.htm" name="content">
		</frameset>
	</frameset>
