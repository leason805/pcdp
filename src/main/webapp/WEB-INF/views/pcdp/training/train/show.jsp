	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" model="form" id="mForm" method="post" action="${ctx}/system/training/train/sign/${model.id}.htm">
					
					<div class="form-group ">
						<label class="col-sm-2 control-label">培训名称</label>
						<div class="col-sm-4">
							${model.arrange.course.name }
						</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							${model.arrange.courseDate }
						</div>
						<label class="col-sm-2 control-label">培训时间</label>
						<div class="col-sm-4">
							${model.arrange.courseTime }
						</div>
					</div>
