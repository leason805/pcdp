...
function UserTable(){
	...
	oTable = $('#datatable-m').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/training/train/listdata.htm",
		"aoColumns": [
					  { "mData": "arrange.course.name" },
					  { "mData": "status" },
					  { "mData": "arrange.courseDate" },
		              { "mData": "arrange.courseTime" },
...
function edit(type, id){
	var url = "";
	if(type == 1){
		url = "${ctx}/system/training/train/show/" + id + ".htm";
