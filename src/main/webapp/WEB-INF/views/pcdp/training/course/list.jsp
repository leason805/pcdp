			...
			<div class="box-content no-padding table-responsive">
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-m">
					<thead>
						...
						<tr>
							<th colspan="6">
								<a class='iframe btn btn-primary btn-label-left' href="${ctx}/system/training/course/show/.htm">
...
function UserTable(){
	...
	oTable = $('#datatable-m').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/training/course/listdata.htm",
		"aoColumns": [
		              { "mData": "name" },
		              { "mData": "status" },
		              { "mData": "description" },
...
function edit(id){
	var url = "${ctx}/system/training/course/show/" + id + ".htm";
