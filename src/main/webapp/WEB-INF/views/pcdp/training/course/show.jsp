		...
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="
					<c:choose>
       					<c:when test="${empty model}">
							${ctx}/system/training/course/create.htm
       					</c:when>
       					<c:otherwise>
              				 ${ctx}/system/training/course/update/${model.id}.htm
       					</c:otherwise>
					</c:choose>">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="名称" data-toggle="tooltip" data-placement="bottom" title="培训名称" name="name" value="${model.name }">
						</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-styles">培训描述</label>
						<div class="col-sm-10">
