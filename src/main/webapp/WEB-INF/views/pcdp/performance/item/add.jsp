	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="${ctx}/system/capacity/item/createitem.htm">
					<input name="indicatorId" type="hidden" id="indicatorId" value="${id }" />
					
					<div class="form-group ">
						<label class="col-sm-2 control-label">序号</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="序号" data-toggle="tooltip" data-placement="bottom" title="序号" name="sequence" value="">
						</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-styles">要点描述</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<button type="button" class="btn btn-default btn-label-left" onclick="closeBox();">
...
function closeBox(){
	document.location.href = "${ctx}/system/capacity/item/content/${id}.htm";
}
</script>
</body>
</html>