...
$(document).ready(function() {
	...
	<frameset rows="5,1*" frameborder="no" framespacing="0">
		...
		<frameset cols="300,1*" >
			<frame src="${ctx}/system/performance/item/nav/${id}.htm" name="nav" scrolling="NO" marginwidth="0" marginheight="0">
			<frame src="${ctx}/system/performance/item/content/.htm" name="content">
		</frameset>
	</frameset>
