		...
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="
					<c:choose>
       					<c:when test="${empty model}">
							${ctx}/system/knowledge/project/create.htm
       					</c:when>
       					<c:otherwise>
              				 ${ctx}/system/knowledge/project/update/${model.id}.htm
       					</c:otherwise>
					</c:choose>">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="名称" data-toggle="tooltip" data-placement="bottom" title="试卷名称" name="title" value="${model.title }">
						</div>
						...
						<div class="col-sm-4">
							...
							<label>
								...
								<input type="radio" name="projectType" value="RANDOM" <c:if test="${model.projectType == 'RANDOM'}">checked</c:if>> 随机 
								<i class="fa fa-circle-o"></i>
							</label>
						</div>
						<div class="radio-inline">
							<label>
								<input type="radio" name="projectType" value="SPECIFY" <c:if test="${model.projectType == 'SPECIFY'}">checked</c:if>> 指定
								<i class="fa fa-circle-o"></i>
							</label>
						</div>
						</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="数量" data-toggle="tooltip" data-placement="bottom" title="试题数量" name="size" value="${model.size }">
						</div>
						<label class="col-sm-2 control-label">次数限制</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="限制" data-toggle="tooltip" data-placement="bottom" title="次数限制" name="limits" value="${model.limits }">
						</div>
					</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="时间" data-toggle="tooltip" data-placement="bottom" title="考试时间" name="minutes" value="${model.minutes }">
						</div>
