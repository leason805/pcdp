			...
			<div class="box-content no-padding table-responsive">
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-m">
					<thead>
						...
						<tr>
							<th colspan="7">
								<a class='iframe btn btn-primary btn-label-left' href="${ctx}/system/knowledge/project/show/.htm">
...
function UserTable(){
	...
	oTable = $('#datatable-m').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/knowledge/project/listdata.htm",
		"aoColumns": [
		              { "mData": "title" },
		              { "mData": "minutes" },
		              { "mData": "size" },
...
function edit(id){
	var url = "${ctx}/system/knowledge/project/show/" + id + ".htm";
