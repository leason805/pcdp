		...
		<div class="box">
			...
			<div class="box-content col-xs-12">
					<div class="form-group col-xs-12">
						<label class="col-md-2 control-label">试题名称</label>
						<div class="col-md-4">
					...
					<div class="form-group col-xs-12">
						...
						<div class="col-md-4">
							${model.arrangeUser.arrange.examDate }
						</div>
					...
					<div class="form-group col-xs-12">
						<label class="col-md-2 control-label">考试结果</label>
						<div class="col-md-4">
							<c:choose>
						...
						<label class="col-md-2 control-label">考试成绩</label>
						<div class="col-md-4">
							${model.score } 分
						</div>
					</div>
			...
			<div class="box-content table-responsive" style="padding:30px;">
				<table aria-describedby="datatable-m_info" class="table table-bordered  table-hover table-heading table-datatable dataTable" id="datatable-m">
					<thead>
						...
						<tr role="row">
							<th aria-sort="" rowspan="1" aria-controls="datatable-m" tabindex="0" role="columnheader" class="">详细记录</th>
						</tr>
					</thead>
							...
							<tr class="odd">
								<td class=" sorting_1">
									...
									<div style="padding-left:15px; padding-top: 10px;">
										正确答案：<br/>
										<c:forEach items="${answer.question.options}" var="option">
											<c:if test="${option.answerType == 'YES' }"> <b> ${option.code } &nbsp;&nbsp; 解析：</b>${option.answerDesc}<br></c:if>
										</c:forEach>
									</div>
								</td>
							</tr> 
