		...
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" id="mForm" method="post" action="
					<c:choose>
       					<c:when test="${empty model}">
							${ctx}/system/knowledge/section/create.htm
       					</c:when>
       					<c:otherwise>
              				 ${ctx}/system/knowledge/section/update/${model.id}.htm
       					</c:otherwise>
					</c:choose>">
				...
				<c:if test="${not empty model}">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<div class="input-group">
									  ...
									  <input type="text" class="form-control" placeholder="章节编号" data-toggle="tooltip" data-placement="bottom" title="章节编号" name="number" value="${model.number}">
									</div>
								</div>
								<label class="col-sm-2 control-label"></label>
								<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-styles">章节描述</label>
						<div class="col-sm-10">
