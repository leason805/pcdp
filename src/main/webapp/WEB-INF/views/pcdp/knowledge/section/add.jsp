	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" id="mForm" method="post" action="${ctx}/system/knowledge/section/create.htm">
					<input name="parentId" type="hidden" id="parentId" value="${model.id }" />
					<input name="companyId" type="hidden" id="companyId" value="${model.company.id }" />
					
					<div class="form-group">
						<label class="col-sm-2 control-label">上级章节</label>
						<div class="col-sm-4">
							${model.name }
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="input-group">
							  ...
							  <input type="text" class="form-control" placeholder="章节下级编号" data-toggle="tooltip" data-placement="bottom" title="章节编号" name="number" value="">
							</div>
						</div>
						<label class="col-sm-2 control-label"></label>
						<div class="col-sm-4">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="章节名称" data-toggle="tooltip" data-placement="bottom" title="章节名称" name="name" value="">
						</div>
						<label class="col-sm-2 control-label"></label>
						<div class="col-sm-4">
