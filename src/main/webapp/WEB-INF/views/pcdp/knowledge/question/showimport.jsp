	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" model="form" id="mForm" method="post" enctype="multipart/form-data" action="${ctx}/system/knowledge/question/imports.htm">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-styles">模板</label>
						<div class="col-sm-10">
								<a style= 'color:#0072bc;' href="${ctx}/template/template.xlsx">下载模板</a>
						</div>
					</div>
