		...
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" model="form" method="post" action="
					<c:choose>
       					<c:when test="${empty model}">
							${ctx}/system/archive/experience/create.htm
       					</c:when>
       					<c:otherwise>
              				 ${ctx}/system/archive/experience/update/${model.id}.htm
       					</c:otherwise>
					</c:choose>">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="所在公司" data-toggle="tooltip" data-placement="bottom" title="所在公司" name="company" value="${model.company }">
						</div>
						<label class="col-sm-2 control-label">所在部门</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="所在部门" data-toggle="tooltip" data-placement="bottom" title="所在部门" name="department" value="${model.department }">
						</div>
					</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="startDate" placeholder="开始日期" data-toggle="tooltip" data-placement="bottom" title="开始日期" name="startDate" value="${model.startDate }">
						</div>
						<label class="col-sm-2 control-label">结束日期</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="endDate" placeholder="留空表示至今" data-toggle="tooltip" data-placement="bottom" title="结束日期" name="endDate" value="${model.endDate }">
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-styles">备注</label>
						<div class="col-sm-10">
