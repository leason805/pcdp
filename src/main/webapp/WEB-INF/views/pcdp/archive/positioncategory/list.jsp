			...
			<div class="box-content no-padding table-responsive">
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-m">
					<thead>
						...
						<tr>
							<th colspan="4">
								<a class='iframe btn btn-primary btn-label-left' href="${ctx}/system/archive/positioncategory/show/.htm">
...
function UserTable(){
	...
	oTable = $('#datatable-m').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/archive/positioncategory/listdata.htm",
		"aoColumns": [
		              { "mData": "name" },
		              { "mData": "categoryType" },
		              { "mData": "description" },
		 ...
		 },
		 {
		        "mRender": function(data, type, row) {
		          ...
		          return '<a href="#" onclick="edit(1,' + data + ');">编辑</a>&nbsp;&nbsp;';
		        },
		        "aTargets": [3]
		 }
		 ],
...
function edit(type, id){
	var url = "";
	if(type == 1){
		url = "${ctx}/system/archive/positioncategory/show/" + id + ".htm";
