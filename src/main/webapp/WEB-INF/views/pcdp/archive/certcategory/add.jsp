	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="${ctx}/system/archive/certcategory/create.htm">
					<input name="parentId" type="hidden" id="parentId" value="${model.id }" />
					
					<div class="form-group">
						<label class="col-sm-2 control-label">上级资格</label>
						<div class="col-sm-4">
							${model.name }
						</div>
					...
					<div class="form-group ">
						<label class="col-sm-2 control-label">资格名称</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="form-styles">资格描述</label>
						<div class="col-sm-10">
