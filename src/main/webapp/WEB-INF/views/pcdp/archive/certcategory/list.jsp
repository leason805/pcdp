					...
					<thead>
						<tr role="row">
							<th rowspan="1" colspan="2">
								<a class="iframe btn btn-primary btn-label-left cboxElement" href="${ctx}/system/archive/certcategory/show/.htm">
...
function edit(type, id){
	var url = "";
	if(type == 1){
		url = "${ctx}/system/archive/certcategory/add/" + id + ".htm";
		$.colorbox({href:url, iframe:true, width:"65%", height:"100%"});
	}
	if(type == 2){
		url = "${ctx}/system/archive/certcategory/show/" + id + ".htm";
		$.colorbox({href:url, iframe:true, width:"65%", height:"100%"});
	}
...
function del(id){
	url = "${ctx}/system/archive/certcategory/del/" + id + ".htm";
