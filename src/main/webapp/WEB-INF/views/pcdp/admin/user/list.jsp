			...
			<div class="box-content no-padding table-responsive">
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-2">
					<thead>
						...
						<tr>
							<th colspan="7">
								<a class='iframe btn btn-primary btn-label-left' href="${ctx}/system/admin/user/show/.htm">
...
function UserTable(){
	var asInitVals = [];
	 oTable = $('#datatable-2').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/admin/user/listdata.htm",
		"aoColumns": [
		              { "mData": "loginID" },
		              { "mData": "name" },
		              { "mData": "company.name" },
...
function create(){
	var content = LoadContent('${ctx}/admin/user/show/.htm');
	OpenWindow(content);
}

function edit(id){

	var url = "${ctx}/system/admin/user/show/" + id + ".htm";
