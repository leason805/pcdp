	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="${ctx}/admin/index/create.htm">
					<input name="parentId" type="hidden" id="parentId" value="${index.id }" />
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="input-group">
							  <span class="input-group-addon" style="font-weight: bold; font-style:italic; font-size: 16;">${index.sequence}.</span>
