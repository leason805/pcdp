			...
			<div class="box-content no-padding table-responsive">
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-m">
					<thead>
						...
						<tr>
							<th colspan="5">
								<a class='iframe btn btn-primary btn-label-left' href="${ctx}/system/admin/module/show/.htm">
...
function UserTable(){
	...
	oTable = $('#datatable-m').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/admin/module/listdata.htm",
		"aoColumns": [
		              { "mData": "name" },
		              { "mData": "url" },
		              { "mData": "order" },
		 ...
		 "aoColumnDefs": [
			 {
			        "mRender": function(data, type, row) {
			          return '<a href="#" onclick="edit(' + data + ');">编辑</a>';
			        },
			        "aTargets": [3]
			 }
		 ],
...
function create(){
	var content = LoadContent('${ctx}/system/admin/module/show/.htm');
	OpenWindow(content);
}

function edit(id){
	var url = "${ctx}/system/admin/module/show/" + id + ".htm";
