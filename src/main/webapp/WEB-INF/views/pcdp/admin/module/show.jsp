		...
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="
					<c:choose>
       					<c:when test="${empty module}">
							${ctx}/system/admin/module/create.htm
       					</c:when>
       					<c:otherwise>
              				 ${ctx}/system/admin/module/update/${module.id}.htm
       					</c:otherwise>
					</c:choose>">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="名称" data-toggle="tooltip" data-placement="bottom" title="用户姓名" name="name" value="${module.name }">
						</div>
						<label class="col-sm-2 control-label">URL</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="URL" name="url" value="${module.url }">
						</div>
					</div>
					<div class="form-group ">
						<label class="col-sm-2 control-label">代码</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="代码" name="code" value="${module.code }">
						</div>
						<label class="col-sm-2 control-label">顺序</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="顺序" name="order" value="${module.order }">
						</div>
					</div>
					<div class="form-group ">
						<label class="col-sm-2 control-label">图标</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="图标" name="icon" value="${module.icon }">
						</div>
