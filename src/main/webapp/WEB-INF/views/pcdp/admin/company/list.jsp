			...
			<div class="box-content no-padding table-responsive">
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-m">
					<thead>
						...
						<tr>
							<th colspan="3">
								<a class='iframe btn btn-primary btn-label-left' href="${ctx}/system/admin/company/show/.htm">
...
function UserTable(){
	...
	oTable = $('#datatable-m').dataTable( {
		//"aaSorting": [[ 0, "asc" ]],
		"sAjaxSource": "${ctx}/system/admin/company/listdata.htm",
		"aoColumns": [
		              { "mData": "name" },
		              { "mData": "description" },
		              { "mData": "id" }
...
function edit(type, id){
	var url = "";
	if(type == 1){
		url = "${ctx}/system/admin/company/show/" + id + ".htm";
