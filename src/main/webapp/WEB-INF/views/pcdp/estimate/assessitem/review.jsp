	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="${ctx}/system/estimate/assessitem/update/${model.id}.htm">
					...
					<div class="form-group ">
						...
						<label class="col-sm-2 control-label"><h4>最终得分</h4></label>
						<div class="col-sm-4">
							<h3>${model.assessScore }</h3>
						</div>
					</div>
						...
						<table aria-describedby="datatable-m_info" class="table table-bordered  table-hover table-heading table-datatable dataTable" id="datatable-m">
							<thead>
								<tr role="row">
									...
									<th colspan="1" rowspan="1" aria-controls="datatable-m" tabindex="0" role="columnheader" class="">我的评分</th>
									<th colspan="1" rowspan="1" aria-controls="datatable-m" tabindex="0" role="columnheader" class="">权重评分</th>
								</tr>
							</thead>
							
							<tbody aria-relevant="all" aria-live="polite" role="alert">
								<c:import url="tag_review.jsp" />
							</tbody>
						</table>
					</div>
