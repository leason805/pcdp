	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" id="mForm" model="form" method="post" action="${ctx}/system/estimate/assess/update/${model.id}.htm">
					...
					<div class="form-group">
						<div style="margin-left:80px" class="col-sm-offset-4 col-sm-2">
							<div class="easyui-layout" style="width:700px;height:420px;">
								<div data-options="region:'east',split:true" title="已分配检查员" style="width:330px;">
									<table id="assignedusers" class="easyui-datagrid" style="height:370px"
										data-options="rownumbers:true,singleSelect:false,url:'${ctx}/system/estimate/assess/loaduser.htm?id=${model.id}&type=assigned',method:'get'">
										<thead>
											<tr>
								...
								<div data-options="region:'west',split:true" title="未分配检查员" style="width:330px;">
									<table id="unassignedusers" class="easyui-datagrid" style="height:370px"
										data-options="rownumbers:true,singleSelect:false,url:'${ctx}/system/estimate/assess/loaduser.htm?id=${model.id}&type=unassigned',method:'get'">
										<thead>
											<tr>
												<th data-options="field:'id',checkbox:true"></th>
												<th data-options="field:'account',width:100">登录ID</th>
