		...
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="
					<c:choose>
       					<c:when test="${empty model}">
							${ctx}/system/estimate/indicatorcategory/create.htm
       					</c:when>
       					<c:otherwise>
              				 ${ctx}/system/estimate/indicatorcategory/update/${model.id}.htm
       					</c:otherwise>
					</c:choose>">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="方案名称" data-toggle="tooltip" data-placement="bottom" title="方案名称" name="name" value="${model.name }">
						</div>
