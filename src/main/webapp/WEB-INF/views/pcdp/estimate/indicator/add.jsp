	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<form class="form-horizontal" role="form" method="post" action="${ctx}/system/estimate/indicator/create.htm">
					<input name="parentId" type="hidden" id="parentId" value="${model.id }" />
					<input name="categoryId" type="hidden" id="categoryId" value="${model.category.id }" />
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="input-group">
							  <span class="input-group-addon" style="font-weight: bold; font-style:italic; font-size: 16;">${model.sequence}.</span>
							  <input type="text" class="form-control" placeholder="指标下级编号" data-toggle="tooltip" data-placement="bottom" title="指标编号" name="number" value="">
							</div>
						</div>
						<label class="col-sm-2 control-label"></label>
						<div class="col-sm-4">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="指标名称" data-toggle="tooltip" data-placement="bottom" title="指标名称" name="name" value="">
						</div>
						<label class="col-sm-2 control-label"></label>
						<div class="col-sm-4">
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<div class="toggle-switch toggle-switch-success">
								<label>
									<input type="checkbox" name="mandatory" value="YES" data-toggle="tooltip" data-placement="bottom" title="默认不是硬性指标">
