...
@Repository("certcategoryDao")
public class CertCategoryDaoImpl extends GenericDaoImpl<ACertCategory, Long>{
	...
	@Override
	public void saveOrUpdate(Collection<ACertCategory> entitys)
