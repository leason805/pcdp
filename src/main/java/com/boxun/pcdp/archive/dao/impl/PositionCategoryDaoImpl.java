...
@Repository("positioncategoryDao")
public class PositionCategoryDaoImpl extends GenericDaoImpl<APositionCategory, Long>{
	...
	@Override
	public void saveOrUpdate(Collection<APositionCategory> entitys)
