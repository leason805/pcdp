...
@Repository("evaluatereviewDao")
public class EvaluateReviewDaoImpl extends GenericDaoImpl<CEvaluateReview, Long>{
	...
	@Override
	public void saveOrUpdate(Collection<CEvaluateReview> entitys)
