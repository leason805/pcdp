...
@Repository("carrangeuserDao")
public class EvaluateArrangeUserDaoImpl extends GenericDaoImpl<CEvaluateArrangeUser, Long>{
	...
	@Override
	public void saveOrUpdate(Collection<CEvaluateArrangeUser> entitys)
