...
@Repository("assessProjectDao")
public class AssessProjectDaoImpl extends GenericDaoImpl<EAssessProject, Long>{
	...
	@Override
	public void saveOrUpdate(Collection<EAssessProject> entitys)
