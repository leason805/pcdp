...
@Repository("indicatorcategoryDao")
public class IndicatorCategoryDaoImpl extends GenericDaoImpl<EIndicatorCategory, Long>{
	...
	@Override
	public void saveOrUpdate(Collection<EIndicatorCategory> entitys)
