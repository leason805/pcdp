...
@Repository("assessdetailDao")
public class AssessDetailDaoImpl extends GenericDaoImpl<EAssessDetail, Long>{
	...
	@Override
	public void saveOrUpdate(Collection<EAssessDetail> entitys)
